classdef Delay3test < audioPlugin
    % DELAY3
    ...
    properties (Constant)
        ...
        dreamy = PresetTest(0.3, 0.5, 0.5, 0.8,...% Delay, Gain, Feedback, Mix,
                            1500, 12, 9, 3,...      % Fc, filter Q, vDepth, vRate,
                            0.1, 0.1, 0.1, 0.2,...   % sGain, sQ, sDist, sMix
                            1, 1, 0, 0, 1, 0) 
        wacky = PresetTest(0.015, 1, 0.5, 0.7,...% Delay, Gain, Feedback, Mix,
    ...
    methods
        ...
        function set.PresetChoice(obj, choice)
            obj.PresetChoice = choice;
            UpdatePreset(obj);
        end
